...
class Logger:
    ...
    def __init__(self, logs_dir_path: str | Path = "logs"):
        self._logs_dir_path = project_root_path / logs_dir_path
        self._file_handlers = []
    ...
    def _setup_handlers(self):
        ...
        handler_id = self.logger.add(
            self._logs_dir_path / "all.log", rotation="500 MB", format=format_string
        )
        self._file_handlers.append(handler_id)
